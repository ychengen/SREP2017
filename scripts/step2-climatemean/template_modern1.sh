...
for i in {1..24}
  do
    ...
    ncra -F -d time,$start,$end -v cLeaf cLeaf_Lmon_modelnm_historical_r1i1p1_198201-200512.nc  cLeaf_Lmon_modelnm_historical_r1i1p1_$index.nc
    ncra -F -d time,$start,$end -v cRoot cRoot_Lmon_modelnm_historical_r1i1p1_198201-200512.nc  cRoot_Lmon_modelnm_historical_r1i1p1_$index.nc
    ncra -F -d time,$start,$end -v cVeg cVeg_Lmon_modelnm_historical_r1i1p1_198201-200512.nc  cVeg_Lmon_modelnm_historical_r1i1p1_$index.nc
    ncra -F -d time,$start,$end -v cWood cWood_Lmon_modelnm_historical_r1i1p1_198201-200512.nc  cWood_Lmon_modelnm_historical_r1i1p1_$index.nc
    ncra -F -d time,$start,$end -v landCoverFrac landCoverFrac_Lmon_modelnm_historical_r1i1p1_198201-200512.nc  landCoverFrac_Lmon_modelnm_historical_r1i1p1_$index.nc
    ncra -F -d time,$start,$end -v treeFrac treeFrac_Lmon_modelnm_historical_r1i1p1_198201-200512.nc  treeFrac_Lmon_modelnm_historical_r1i1p1_$index.nc
    ncra -F -d time,$start,$end -v pr pr_Amon_modelnm_historical_r1i1p1_198201-200512.nc  pr_Amon_modelnm_historical_r1i1p1_$index.nc
    ncra -F -d time,$start,$end -v tas tas_Amon_modelnm_historical_r1i1p1_198201-200512.nc  tas_Amon_modelnm_historical_r1i1p1_$index.nc
    ncra -F -d time,$start,$end -v rsds rsds_Amon_modelnm_historical_r1i1p1_198201-200512.nc  rsds_Amon_modelnm_historical_r1i1p1_$index.nc

done

mv *_198201-200512.nc ../
