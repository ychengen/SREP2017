...
ln -s ../Observation/GSWP3/regrid_for_CMIP5/climate_mean/PI/masked/individual/frac0/*.nc .
ln -s ../CMIP5/climate_mean/PI/masked/individual/frac0/mask_climate_*.nc .
mkdir -p input_data/PI/individual/frac0
...
mv *.nc input_data/PI/individual/frac0/
...
do
   ...
   ln -s ../Observation/GSWP3/regrid_for_CMIP5/climate_mean/PI/masked/individual/frac0.$i/*.nc .
   ln -s ../CMIP5/climate_mean/PI/masked/individual/frac0.$i/mask_climate_*.nc .
   mkdir -p input_data/PI/individual/frac0.$i
...
# MIROC-ESM   
   ...
   mv *.nc input_data/PI/individual/frac0.$i/
done
