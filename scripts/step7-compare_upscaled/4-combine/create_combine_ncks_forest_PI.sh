...
cd postanalysis
ln -s ../Observation/GSWP3/regrid_for_CMIP5/climate_mean/PI/masked/frac0/*.nc .
ln -s ../CMIP5/climate_mean/PI/masked/frac0/mask_climate_*.nc .
mkdir -p input_data/PI/frac0
...
do
   ...
   ln -s ../Observation/GSWP3/regrid_for_CMIP5/climate_mean/PI/masked/frac0.$i/*.nc .
   ln -s ../CMIP5/climate_mean/PI/masked/frac0.$i/mask_climate_*.nc .
   mkdir -p input_data/PI/frac0.$i
