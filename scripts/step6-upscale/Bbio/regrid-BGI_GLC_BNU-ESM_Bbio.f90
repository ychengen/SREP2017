!!!=================================================================
!!! Regrid 1km to BNU-ESM resolution for 22 vegetation types - Bbio
!!!=================================================================
...
character(len=*), parameter :: FNAME4 =     &
  "/lustre/atlas/scratch/ceyang1/cli017/BGC-Biomass/CMIP5/BNU-ESM/1982-2005/cRoot_Lmon_BNU-ESM_historical_r1i1p1_198201-200512.nc"
character(len=*), parameter :: FOUTNAME =   &
  "/lustre/atlas/scratch/ceyang1/cli017/BGC-Biomass/CMIP5/landcover_GLC2000_for_CMIP5/Bbio/landcover_BGI_Bbio_BNU-ESM.nc"
