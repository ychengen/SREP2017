!!!=================================================================
!!! Regrid 1km to IPSL-CM5B-LR resolution for 22 vegetation types - Bbio
!!!=================================================================
...
character(len=*), parameter :: FNAME4 =     &
  "/lustre/atlas/scratch/ceyang1/cli017/BGC-Biomass/CMIP5/IPSL-CM5B-LR/1982-2005/cRoot_Lmon_IPSL-CM5B-LR_historical_r1i1p1_198201-200512.nc"
character(len=*), parameter :: FOUTNAME =   &
  "/lustre/atlas/scratch/ceyang1/cli017/BGC-Biomass/CMIP5/landcover_GLC2000_for_CMIP5/Bbio/landcover_BGI_Bbio_IPSL-CM5B-LR.nc"

integer, parameter :: NDIMS=3, NTYPES=22, NLATS1=5000, NLONS1=36000, &
                      NLATS2=96, NLONS2=96, NTIME2=288
