!!!=================================================================
!!! Regrid 1km to HadGEM2-ES resolution for 22 vegetation types - Bbio
!!!=================================================================
...
character(len=*), parameter :: FNAME4 =     &
  "/lustre/atlas/scratch/ceyang1/cli017/BGC-Biomass/CMIP5/HadGEM2-ES/1982-2005/cRoot_Lmon_HadGEM2-ES_historical_r1i1p1_198112-200511.nc"
character(len=*), parameter :: FOUTNAME =   &
  "/lustre/atlas/scratch/ceyang1/cli017/BGC-Biomass/CMIP5/landcover_GLC2000_for_CMIP5/Bbio/landcover_BGI_Bbio_HadGEM2-ES.nc"

integer, parameter :: NDIMS=3, NTYPES=22, NLATS1=5000, NLONS1=36000, &
                      NLATS2=145, NLONS2=192, NTIME2=288
