!!!=================================================================
!!! Regrid 1km to IPSL-CM5A-LR resolution for 22 vegetation types - cWood
!!!=================================================================
...
character(len=*), parameter :: FNAME4 =     &
  "/lustre/atlas/scratch/ceyang1/cli017/BGC-Biomass/CMIP5/IPSL-CM5A-LR/1982-2005/cWood_Lmon_IPSL-CM5A-LR_historical_r1i1p1_198201-200512.nc"
character(len=*), parameter :: FOUTNAME =   &
  "/lustre/atlas/scratch/ceyang1/cli017/BGC-Biomass/CMIP5/landcover_GLC2000_for_CMIP5/cWood/landcover_BGI_cWood_IPSL-CM5A-LR.nc"
