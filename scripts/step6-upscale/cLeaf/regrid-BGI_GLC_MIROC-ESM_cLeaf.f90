!!!=================================================================
!!! Regrid 1km to MIROC-ESM resolution for 22 vegetation types - cLeaf
!!!=================================================================
...
character(len=*), parameter :: FNAME4 =     &
  "/lustre/atlas/scratch/ceyang1/cli017/BGC-Biomass/CMIP5/MIROC-ESM/1982-2005/cLeaf_Lmon_MIROC-ESM_historical_r1i1p1_198201-200512.nc"
character(len=*), parameter :: FOUTNAME =   &
  "/lustre/atlas/scratch/ceyang1/cli017/BGC-Biomass/CMIP5/landcover_GLC2000_for_CMIP5/cLeaf/landcover_BGI_cLeaf_MIROC-ESM.nc"
