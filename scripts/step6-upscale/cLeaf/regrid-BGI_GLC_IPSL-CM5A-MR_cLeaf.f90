!!!=================================================================
!!! Regrid 1km to IPSL-CM5A-MR resolution for 22 vegetation types - cLeaf
!!!=================================================================
...
character(len=*), parameter :: FNAME1 =     &
  "/lustre/atlas/scratch/ceyang1/cli017/BGC-Biomass/Observation/BGI2014/1km/BGI_cLeaf_1km.nc"
...
character(len=*), parameter :: FNAME4 =     &
  "/lustre/atlas/scratch/ceyang1/cli017/BGC-Biomass/CMIP5/IPSL-CM5A-MR/1982-2005/cLeaf_Lmon_IPSL-CM5A-MR_historical_r1i1p1_198201-200512.nc"
character(len=*), parameter :: FOUTNAME =   &
  "/lustre/atlas/scratch/ceyang1/cli017/BGC-Biomass/CMIP5/landcover_GLC2000_for_CMIP5/cLeaf/landcover_BGI_cLeaf_IPSL-CM5A-MR.nc"
